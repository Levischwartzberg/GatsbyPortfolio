    ...
    return (
        <div className="portfolio-background">
            <div className="portfolio" id="portfolio">
                <h2>Portfolio</h2>
                <div className="row">
                    <Project classes="card col-12" title="Music Lab" image={MusicLab} link="https://polar-lake-37415.herokuapp.com/" alt="Music Lab homepage"/>
                    ...
                    <Project classes="card col-12 col-lg-6" title="Levi's Kitchen" image={Kitchen} link="https://levischwartzberg.github.io/Levis_Kitchen/" alt="Restaurant homepage"/>
